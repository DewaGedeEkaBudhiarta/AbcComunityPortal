                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h1>ABC Jobs HTML Landing Page</h1>
                            <p class="p-large">Use ABC to automate your marketing actions in order to reach a much larger audience</p>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>It's very easy to start creating email lists for your marketing actions. Just create your ABC account</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Campaigns is a feature we've developed since the beginning because it's at the core of ABC's functionalities</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>ABC Jobs collects customer data in order to help you analyse different situations and take required action</p>
                        </div>
                    </div>
                    <!-- end of card -->
