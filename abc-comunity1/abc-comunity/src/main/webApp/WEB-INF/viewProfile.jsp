		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="id" name="uid" readonly="readonly" value="${viewProfile.id_user}">
				</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="role" readonly="readonly" name="Role" value="${viewProfile.role}">
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
			...
			<div>
			<center>
			<button type="submit" class="btn-outline-sm" href="update" style="color : black;">Update</button>
            </center>
			</div>
		</div>
	</div>
